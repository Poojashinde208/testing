...
var MarkdownPipe = class _MarkdownPipe {
  ...
  transform(value, options2) {
    return __async(this, null, function* () {
      ...
      this.zone.onStable.pipe((0, import_operators.first)()).subscribe(() => this.markdownService.render(this.elementRef.nativeElement, options2, this.viewContainerRef));
